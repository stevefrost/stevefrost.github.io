...
class BeetleMorph extends Enemy {
    constructor(game) {
        ...
        this.lastFrame = 3;
        this.states = [new Flying(game, this), new Imploding(game, this)];
        this.currentState;
    }
    start() {
        super.start();
    ...
    hit() {
        super.hit();
        if (!this.isAlive()) this.setState(1);
    }
...
class Flying extends EnemyState {
    start() {
        ...
        this.enemy.speedX = this.enemy.hasXMovement ?Math.random() * 2 - 1 : 0;
